...
mason add core --git-url https://github.com/emintolgahanpolat/flutter_mason --git-path ./bricks/core
mason add repository --git-url https://github.com/emintolgahanpolat/flutter_mason --git-path ./bricks/repository
mason add service --git-url https://github.com/emintolgahanpolat/flutter_mason --git-path ./bricks/service
mason add page --git-url https://github.com/emintolgahanpolat/flutter_mason --git-path ./bricks/page
mason get
